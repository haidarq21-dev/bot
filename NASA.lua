...
LuaTele = luatele.set_config{api_id=34064992,api_hash='90e6108aee0118a022e06bde63283327',session_name=NASA,token=Token}
function var(value)
...
data = {
{
{text = '👤 | مبرمج السورس', url = 't.me/ln_py'}, 
},
{
{text = '🔘 | تواصل معنا', url = 't.me/ln_py'}, 
},
}
}
...
{
{text = '☢️ | اضغط هنا لتنصيب', url = 't.me/Masn_hbot'}, 
},
{
{text = '🔘 | تواصل معنا', url = 't.me/ln_py'}, 
},
